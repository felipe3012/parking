    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
      <ul class="nav" id="side-menu">
        ...
        <li class="nav-small-cap m-t-10">--- Menu Principal</li>
         <li> <a href="{!!url('/')!!}" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="Z"></i> <span class="hide-menu"> Inicio  </span></a>
        ...
        <li><a href="{!!url('cajas')!!}" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Caja </span></a>
