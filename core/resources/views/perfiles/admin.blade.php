  ...
  <div class="row">
        <div class="col-md-12">
          <div class="white-box">
            ...
            {!!Html::decode(link_to_route('perfiles.create','<button type="button" class="btn btn-sm btn-warning "><i class="fa fa-plus"></i> Nuevo</button>',[],['class'=>'iframe','title'=>'Nuevo perfil','data-icon'=>'fa fa-plus']))!!}
            </div> </h3>
