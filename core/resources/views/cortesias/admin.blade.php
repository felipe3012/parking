  ...
  <div class="row">
        <div class="col-md-12">
          <div class="white-box">
            ...
            {!!Html::decode(link_to_route('clientes.create','<button type="button" class="btn btn-sm btn-warning "><i class="fa fa-plus"></i> Nueva</button>',[],['class'=>'iframe','title'=>'Nuevo cliente','data-icon'=>'fa fa-plus']))!!}
            </div> </h3>
